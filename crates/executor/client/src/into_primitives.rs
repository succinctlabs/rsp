...
impl BlockValidator<ChainSpec> for EthPrimitives {
    ...
    fn validate_block_post_execution(
        ...
        // reth v2.2 collapsed the (receipts, requests) pair into the full `BlockExecutionResult`
        // and added an optional pre-computed (receipts_root, logs_bloom) override (we pass
        // `None`, letting validation recompute from the receipts).
