...
use rsp_client_executor::{
    io::ClientExecutorInput, ChainVariant, EthereumVariant, ImmutableTestnetVariant,
    ImmutableVariant, LineaVariant, OptimismVariant, Variant,
};
    ...
    pub async fn execute(
        ...
        let client_input = match variant {
            ...
            ChainVariant::ImmutableTestnet => {
                self.execute_variant::<ImmutableTestnetVariant>(block_number).await
            }
        }?;
